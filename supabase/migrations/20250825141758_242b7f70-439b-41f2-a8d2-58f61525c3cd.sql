...
-- Adicionar política RLS específica para transações automáticas do sistema
CREATE POLICY "System can create automatic financial transactions"
ON public.financial_transactions
FOR INSERT
WITH CHECK (
  -- Permitir inserções automáticas identificadas pelo metadata
  (metadata->>'auto_generated')::boolean = true
);