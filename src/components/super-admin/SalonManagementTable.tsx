...
import SalonViewModal from './salon-management/SalonViewModal';
import SalonEditModal from './salon-management/SalonEditModal';
...
const SalonManagementTable = ({ salons, loading, onRefresh }: SalonManagementTableProps) => {
  ...
  const [selectedSalonForView, setSelectedSalonForView] = useState<any | null>(null);
  const [selectedSalonForEdit, setSelectedSalonForEdit] = useState<any | null>(null);
  ...
  const handleViewSalon = (salon: any) => {
    setSelectedSalonForView(salon);
