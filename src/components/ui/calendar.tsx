    ...
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 pointer-events-auto cursor-pointer hover:bg-accent hover:text-accent-foreground focus:bg-primary focus:text-primary-foreground"
        ),
        ...
        day_disabled: "text-muted-foreground opacity-50 pointer-events-none cursor-not-allowed",
        day_range_middle:
