...
const AdminDashboardTabs = () => {
  return (
    <TabsList className="grid w-full grid-cols-5 bg-card/50 backdrop-blur-sm p-1 rounded-xl h-auto shadow-lg">
      <TabsTrigger 
        value="overview" 
        className="rounded-lg data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-md transition-all duration-200 py-3"
      >
